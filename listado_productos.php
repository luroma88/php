                    ...
                    <table class="table table-hover border">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo $aProductos["stock"][0] >10? "Hay stock" : ($aProductos["stock"][0] ==0 && $aProductos["stock"][0] <=10? "No hay stock": "Hay poco stock" ); ?></td>
                            ...
                            <tr>
                                ...
                                <td><?php echo $aProductos["stock"][1] >10? "Hay stock" : ($aProductos["stock"][1] ==0 && $aProductos["stock"][1] <=10? "No hay stock": "Hay poco stock" ); ?></td>
                            ...
                            <tr>
                                ...
                                <td><?php echo $aProductos["stock"][2] >10? "Hay stock" : ($aProductos["stock"][2] ==0 && $aProductos["stock"][2] <=10? "No hay stock": "Hay poco stock" ); ?></td>
